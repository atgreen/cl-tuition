...
(defun copy-style (style)
  "Create a shallow copy of STYLE."
  (let ((s (make-instance 'style)))
    (setf (style-foreground s) (style-foreground style)
          (style-background s) (style-background style)
          (style-bold s) (style-bold style)
          (style-italic s) (style-italic style)
          (style-underline s) (style-underline style)
          (style-underline-color s) (style-underline-color style)
          (style-blink s) (style-blink style)
          (style-reverse s) (style-reverse style)
          (style-strikethrough s) (style-strikethrough style)
          (style-faint s) (style-faint style)
          (style-hyperlink s) (style-hyperlink style)
          (style-padding-left s) (style-padding-left style)
          (style-padding-right s) (style-padding-right style)
          (style-padding-top s) (style-padding-top style)
          (style-padding-bottom s) (style-padding-bottom style)
          (style-padding-char s) (style-padding-char style)
          (style-margin-left s) (style-margin-left style)
          (style-margin-right s) (style-margin-right style)
          (style-margin-top s) (style-margin-top style)
          (style-margin-bottom s) (style-margin-bottom style)
          (style-margin-char s) (style-margin-char style)
          (style-width s) (style-width style)
          (style-height s) (style-height style)
          (style-max-width s) (style-max-width style)
          (style-max-height s) (style-max-height style)
          (style-inline s) (style-inline style)
          (style-align s) (style-align style))
    s))
